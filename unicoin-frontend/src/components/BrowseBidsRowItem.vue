  ...
  <md-card style="padding: 30px">
    <div class="md-layout">
      <div class="md-layout-item">
        ...
        <p>
          <b>Bid ID: {{ bidInformation.id }}</b>
        </p>
        <p><b>Your offer:</b> {{ bidInformation.offer }} USD</p>
        <p v-if="bidInformation.bidStatus == 0"><b>Bid status: </b><md-chip>Pending</md-chip></p>
        <p v-if="bidInformation.bidStatus == 1">
          <b>Bid status: </b><md-chip class="md-primary">Accepted</md-chip> View your licence on your
          <a href="/MyLicences">Licences</a> page
        </p>
        <p v-if="bidInformation.bidStatus == 2"><b>Bid status: </b><md-chip class="md-accent">Rejected</md-chip></p>
        <p v-if="bidInformation.bidStatus == 3">
          <b>Bid status: </b><md-chip class="md-primary">Sale</md-chip> Successfully purchased. View your licence on
          your <a href="/MyLicences">Licences</a> page.
        </p>
        <p v-if="bidInformation.bidStatus == 4"><b>Bid status: </b><md-chip class="md-accent">Cancelled</md-chip></p>

        <md-button v-if="bidInformation.bidStatus == 1" class="md-primary" download :href="bidInformation.pdfFile"
          >Download paper
        </md-button>
        <md-button
          v-else-if="bidInformation.bidStatus == 3"
        ...
        <md-button class="md-primary md-raised" v-if="bidInformation.bidStatus == 0" @click="cancelBid"
          >Cancel bid</md-button
        >
