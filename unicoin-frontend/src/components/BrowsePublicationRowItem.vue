    ...
    <div class="md-layout">
      <div class="md-layout-item">
        ...
        <p v-if="publicationInformation.isAuction">
          <b>Commercial licencing details:</b> The author has elected to sell commercial licences to their work through
          an auction. Please submit your bid below.
        </p>
        <p v-else>
        ...
        <md-dialog v-model:md-active="showDialog1">
          <md-tabs md-dynamic-height>
            <md-tab md-label="Copyright notice">
              ...
              <ol>
                <li>
                  <b>Attribution</b> — You must give appropriate credit, provide a link to the license, and indicate if
                  changes were made. You may do so in any reasonable manner, but not in any way that suggests the
                  licensor endorses you or your use.
                </li>
                <li><b>NonCommercial</b> — You may not use the material for commercial purposes.</li>
                <li>
                  <b>NoDerivatives</b> — If you remix, transform, or build upon the material, you may not distribute the
                  modified material.
                </li>
                <li>
                  <b>No additional restrictions</b> — You may not apply legal terms or technological measures that
          ...
          <md-dialog-actions>
            ...
            <md-button class="md-primary md-raised" download :href="publicationInformation.pdfFile">Download</md-button>
          </md-dialog-actions>
        </md-dialog>
        ...
        <md-dialog v-model:md-active="showDialog3">
          ...
          <md-dialog-actions>
            ...
            <md-button class="md-primary md-raised" @click="makeBid((offer = publicationInformation.sellPrice))"
              >Purchase licence</md-button
            >
          </md-dialog-actions>
        </md-dialog>
        ...
        <md-dialog v-model:md-active="showDialog4">
          <md-tabs md-dynamic-height>
            <md-tab md-label="Make donation">
              ...
              <p>
                Your funding will support this researcher, {{ publicationInformation.authorFirstName }}
                {{ publicationInformation.authorLastName }}, to conduct the research specified.
              </p>
