...
export interface ILicenceManagerContract
  extends Truffle.Contract<ILicenceManagerInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<ILicenceManagerInstance>;
}
...
export interface ILicenceManagerInstance extends Truffle.ContractInstance {
  /**
