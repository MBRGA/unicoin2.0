...
export interface UnicoinPaymasterContract
  extends Truffle.Contract<UnicoinPaymasterInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<UnicoinPaymasterInstance>;
}
...
export interface UnicoinPaymasterInstance extends Truffle.ContractInstance {
