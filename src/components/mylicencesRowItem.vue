    ...
    <div class="md-layout">
      <div class="md-layout-item">
        ...
        <p>
          ...
          <b>
            <i
              >{{ licenceInformation.publicationInformation[0].authorFirstName }}
              {{ licenceInformation.publicationInformation[0].authorLastName }}</i
            > </b
          >, {{ licenceInformation.publicationInformation[0].authorUniversity }}
          <a
        ...
        <md-card-actions>
          <md-button class="md-primary md-raised" download :href="licenceInformation.publicationInformation[0].pdfFile"
            >DOWNLOAD PDF</md-button
          >
          <md-button type="submit" class="md-raised md-accent" :disabled="sending" @click="DOWNLOAD_LICENCE"
            >DOWNLOAD LICENCE</md-button
          >
          <md-button type="submit" class="md-raised md-accent" :disabled="sending" @click="TRANSFER_TOKEN"
            >TRANSFER TOKEN</md-button
          >
        </md-card-actions>
      </div>
