...
export interface AuctionManagerContract
  extends Truffle.Contract<AuctionManagerInstance> {
  "new"(
    unicoinRegistry: string,
    trustedForwarder: string,
    meta?: Truffle.TransactionDetails
  ): Promise<AuctionManagerInstance>;
}
...
export interface AuctionManagerInstance extends Truffle.ContractInstance {
  auctions(
  ...
  /**
   * After reveal, this determines which bid won the auction
